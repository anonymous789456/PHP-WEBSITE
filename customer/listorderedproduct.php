...
?>
 	 <h4>Your order has been confirmed and delivered</h4><br/>
		...
		<h5 style="margin-top: 0px;">Estimated time of delivery is<b> 3-7days </b>based on your location</h5>
		 <hr/>
...
<?php 
	 ...
	 echo "Your order has been cancelled due to lack of communication to the owner of the artwork and incomplete information.";
...
?>
<hr/>
 <h4 style="text-align: center;"><strong>Order Information</strong></h4>
				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td align="center"> &#8369 '. number_format($result->PROPRICE,2).' </td>';
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		...
		  		<p align="right">Overall Price : &#8369 <?php echo number_format($subtot + $price,2); ?></p>
		  	</div>
		  </div>
		  ...
		  ?>
		   <hr/> 
		  <div class="row">
		 		 <p>Please print your receipt as a proof</p><br/>
		  	  <p style="margin-top: -10px;">We hope you enjoy your purchased products. Have a nice day!</p>
		  	  <h4 style="color: #0ba3b8;">Kapampangan Artwork Exhibit Devs</h4>
		  </div>
		  <?php }?>
  </div> 
