...
<section>
    <div class="container">
        ...
        <ol class="breadcrumb" style="font-size: 20px;">
          <li><a href="index.php" style="color: #313131;">Home</a></li>
    ...
    <div style="text-align: center;">
        <div class="panel">
            <div class="panel-body">
                ...
                style="width:20%; height:20%;text-align:center" title=
                "profile image"></a>
            </div>
            <ul class="list-group">
            <!-- <li class="list-group-item text-muted">Profile</li> -->
                <li class="list-group-item text-right" style="font-size: 17px; text-transform: capitalize; text-align: center; border: none;"><span><strong>User Name:</strong></span>
                <strong><?php echo $res->FNAME .' '.$res->LNAME; ?></strong></li>
                <li class="list-group-item" style="border: none;"> 
                <div class="panel-group" id="accordion">   
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Change Password</a>
                  <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body" style="margin-left: 150px; margin-right: 150px;">
                        <form action="<?php echo web_root; ?>customer/controller.php?action=changepassword" method="POST"> 
                          ...
                          <input class="btn btn-sm btn-primary"  type="submit" name="save"  value="Change" style="font-size: 17px; border-radius: 20px; padding: 10px 30px; margin-top: -8px;">
                        </form>
                      </div>
                  </div>
                </div> 
    ...
    <div class="" >
        <div class="panel" >
            <div class="panel-body">
                <ul class="nav nav-tabs" style="padding-left: 450px;">
                    <li class="active">
                        <a data-toggle="tab" href="#home" style="text-align: center;">My Orders List</a>
                    </li> 
                    <li>
