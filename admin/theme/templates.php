...
<body> 
    <div id="wrapper">
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; margin-top: 20px;">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="logo" href="<?php echo web_root; ?>admin/index.php"><img src="../theme/images/logo.png" style="float: left; margin-left: 45px; width: 170px;"></a>
                 <a class="navbar-brand" href="<?php echo web_root; ?>admin/index.php">Kapampangan's Artwork Exhibit</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right"> 
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user" style="text-align: center; border-radius: 20px;">
                        <li><a style="border-radius: 6px;" href="<?php echo web_root; ?>admin/products/index.php?view=add"><i class="fa fa-upload fa-fw"></i> Artwork</a>
                        </li>
                        <li><a style="border-radius: 6px;" href="<?php echo web_root; ?>admin/category/index.php?view=add"><i class="fa fa-list-alt  fa-fw"></i> Category</a>
                        </li>
                            <?php if ($_SESSION['U_ROLE']=='Administrator') {
                            # code...
                        ?>
                         <li><a style="border-radius: 6px;" href="<?php echo web_root; ?>admin/user/index.php?view=add"><i class="fa fa-user  fa-fw"></i> User</a>
                            </li>
                        <?php }?>
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user  fa-fw"></i><b>Welcome</b> <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="30px" height="26px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                            
                    </a>

                    <ul class="dropdown-menu dropdown-acnt" style="height: 250px; padding-top: 55px; border-radius: 20px;">

                          <div class="divpic" style="margin-left: 69px;"> 
                          ...
                          <t><t>
                      <div class="divtxt" style="text-align: center;">
            ...
            <div class="navbar-default sidebar" role="navigation" style="margin-top: 70px; ">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li style="font-size: 17px; font-style: verdana;">
                             <a href="<?php echo web_root; ?>admin/products/index.php"><i class="fa fa-file-image-o fa-fw"></i> Artworks </a>
           
                        </li>
                        <li style="font-size: 17px; font-style: verdana;">
                             <a href="<?php echo web_root; ?>admin/orders/index.php" ><i class="fa fa-tasks fa-fw"></i>  Process Orders</a>
                  </li>
                        ...
                        ?>
                         <li style="font-size: 17px; font-style: verdana;">
                             <a href="<?php echo web_root; ?>admin/settings/index.php" ><i class="fa fa-cog fa-fw"></i>  Setting </a>
                       ...
                       <!--   <li>
                         ...
                         <li style="font-size: 17px; font-style: verdana;">
                            <a href="<?php echo web_root; ?>admin/report/index.php" ><i class="fa  fa-file-text fa-fw"></i> Sales Report </a>
  ...
  <div id="page-wrapper">
            ...
            <div class="row" >
                ...
                <div class="col-lg-12" style="background: whitesmoke;"> 
