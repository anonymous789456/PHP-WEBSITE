...
<div class="modal-content">
	<div class="modal-header">
		...
		"button" style="color: whitesmoke;">×</button>
		<h2 class="titleorder">Order Number : <?php echo $_SESSION['ordernumber']; ?></h2>
	...
	<div class="row" style="margin:2%;">
		<div style="color: whitesmoke; font-size: 20px; text-transform: capitalize;">Buyer's Name : <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></div>
		<div style="color: whitesmoke; font-size: 20px; text-transform: capitalize; margin-top: 10px; margin-bottom: -10px;">Address :  <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . ' ' .$cur->BRGYADD . ' ' . $cur->CITYADD . ' ' .$cur->PROVINCE . ' ' .$cur->COUNTRY; ?>
     </div>
	</div>
	...
	"post">
		...
		<table id="table" class="table">
			<thead>
				...
				<tbody class="table" style="color: whitesmoke;">
				<?php
				  $subtot =0;
				  $query = "SELECT * 
       ...
       <div class="row" style="color: whitesmoke;">
		  	<div class="col-md-6 pull-left">
		  	 <div style="font-size: 20px;">Ordered Date : <?php echo date_format(date_create($cur->ORDEREDDATE),"M/d/Y h:i:s"); ?></div> 
		  		<div>Payment Method : <?php echo $cur->PAYMENTMETHOD; ?></div>

		  	</div>
		  	<div class="col-md-6 pull-right" style="font-size: 15px;">
		  		...
		  		<p align="right">Overall Price : &#8369 <?php echo number_format($cur->PAYMENT+$cur->DELFEE,2); ?></p>
		  	</div>
		  </div> 
		</div>   
