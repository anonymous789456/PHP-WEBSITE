...
<div class="container">
 ...
 <style type="text/css">
 	...
 	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-shopping-cart" aria-hidden="true"></i> List of Orders</h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
                  ...
                  <table id="example" class="table  table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
					...
					<?php
						echo '<tr>';
				  		...
				  		echo '<td><a href="index.php?view=customerdetails&customerid='.$result->CUSTOMERID.'" title="View customer information" class="orders">'. $result->FNAME.' '. $result->LNAME.'</a></td>';
