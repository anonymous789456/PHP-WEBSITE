<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header" ><i class="fa fa-paint-brush" aria-hidden="true"></i> List of Artworks  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
